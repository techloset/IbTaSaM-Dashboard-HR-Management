    ...
    <div className="max-w-[713px] lg:w-[713px] max-h-[295.344px] mx-auto bg-white rounded-md border-2 border-violet-100 p-6 mb-5 xl:mb-0">
      <div className="flex justify-between">
        ...
        <div className="w-[131px] h-[34px] p-[9.06px] bg-neutral-100 rounded-[10.87px] justify-center items-center gap-[9.06px] inline-flex">
          <div className="text-center text-blue-900 text-xs font-bold font-['Product Sans'] tracking-tight">
            Filter & Short
          </div>
        ...
        <table className="w-full text-sm text-left ">
          <thead className=" border-b">
            <tr>
              <th
                scope="col"
                className="py-3 text-neutral-400 text-[10px] sm:text-sm font-normal font-['Product Sans'] tracking-tight flex-shrink-0"
              >
                Employee Name
              </th>
              <th
                scope="col"
                className="py-3 text-neutral-400 text-[10px] sm:text-sm font-normal font-['Product Sans'] tracking-tight text-center"
              >
                Department
              </th>
              <th
                scope="col"
                className="px-6 py-3 text-neutral-400 text-[10px] sm:text-sm font-normal font-['Product Sans'] tracking-tight"
              >
                Age
              </th>
              <th
              ...
              <th
                scope="col"
                className="pl-6 pr-3 py-3 text-center text-neutral-400 text-[10px] sm:text-sm font-normal font-['Product Sans'] tracking-tight text-end"
              >
                Status
              </th>
            </tr>
